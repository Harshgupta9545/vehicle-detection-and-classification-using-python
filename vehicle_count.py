...
def postProcess(outputs,img):
    ...
    for i in indices.flatten():
        ...
        # cv2.rectangle(img, (x,y-20),(x + 55, y), (0,0,0), -1)
        cv2.putText(img,f'{name.upper()} {int(confidence_scores[i]*100)}%',
                  (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0,255,255), 1,cv2.LINE_AA)
...
def realTime():
    while True:
        ...
        cv2.line(img, (0, middle_line_position), (iw, middle_line_position), (0,255,0), 2)
        cv2.line(img, (0, up_line_position), (iw, up_line_position), (0, 255, 255), 1)
        cv2.line(img, (0, down_line_position), (iw, down_line_position), (0, 255, 255), 1)
